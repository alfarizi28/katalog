...
import 'package:katalog/detailRumah.dart';
...
class _TampilanAwal extends State<TampilanAwal> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text("Katalog Rumah Adat"),
      ),
      body: (isLandscape)
          ? Row(
              ...
              itemBuilder: (context, index) {
                return Card(
                  child: ListTile(
                    title: Text(DataRumah[index].nama),
                    leading: CircleAvatar(
                        backgroundImage: NetworkImage(DataRumah[index].gambar)),
                    onTap: () {
                      Navigator.of(context).push(MaterialPageRoute(
                          builder: ((context) =>
                              rumahDetail(modelRumah: DataRumah[index]))));
                    },
                  ),
                );
              }),
